...
class ContentDocument(BaseModel):
    ...
    partition_key: str = Field(..., alias="partitionKey", description="Partition key (userId)")
    user_id: str = Field(..., alias="userId", description="User identifier (same as partition key)")
