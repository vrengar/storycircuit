...
class ContentPlan(BaseModel):
    ...
    narrative_frame: Optional[str] = Field(None, description="Story structure framework")
            ...
            "example": {
                ...
                "content": {
                    "plan": {
                        ...
                        "key_points": ["Sequential vs parallel execution", "Error handling"],
                    ...
                    "outputs": {
                        "twitter": {
                            ...
                            "tweets": [
                                {"order": 1, "content": "Thread starter...", "character_count": 138}
                            ]
                        }
                    },
