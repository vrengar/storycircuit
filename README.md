...
5. **Access the application:**
   - **Web UI:** http://localhost:8001 (main application interface)
   - **API Docs:** http://localhost:8001/docs (interactive Swagger UI - auto-generated by FastAPI)
   - **ReDoc:** http://localhost:8001/redoc (alternative API documentation view - auto-generated by FastAPI)
